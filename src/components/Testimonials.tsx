    ...
    <section className="relative py-12 md:py-16">
      ...
      <div className="relative max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <button
            onClick={() => scroll('left')}
            className="absolute left-0 z-10 bg-white/10 hover:bg-white/20 backdrop-blur-md p-2 rounded-full transition-colors"
          ...
          <button
            ...
            className="absolute right-0 z-10 bg-white/10 hover:bg-white/20 backdrop-blur-md p-2 rounded-full transition-colors"
          ...
          <div className="relative w-full">
            {/* Left fade */}
            <div className="absolute left-0 top-0 h-full w-12 pointer-events-none bg-gradient-to-r from-black/90 to-transparent z-20" />
            {/* Right fade */}
            <div className="absolute right-0 top-0 h-full w-12 pointer-events-none bg-gradient-to-l from-black/90 to-transparent z-20" />
